<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AssemblySection.aspx.cs" Inherits="DotMercy.custom.AssemblySection" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="masterDataSource" runat="server" 
        ...
        SelectCommand="SELECT [Id], [Code], [Name] FROM [AssemblySections]" 
        DeleteCommand="DELETE FROM [AssemblySections] WHERE [Id] = @Id" 
        InsertCommand="INSERT INTO [AssemblySections] ([Code], [Name]) VALUES (@Code, @Name)" 
        UpdateCommand="UPDATE [AssemblySections] SET [Code] = @Code, [Name] = @Name WHERE [Id] = @Id">
        <DeleteParameters>
