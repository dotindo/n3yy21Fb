<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="STAReason.aspx.cs" Inherits="DotMercy.custom.STAReason" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="masterDataSource" runat="server" 
        ...
        SelectCommand="SELECT [Id], [Name] FROM [STAReasons]" 
        DeleteCommand="DELETE FROM [STAReasons] WHERE [Id] = @Id" 
        InsertCommand="INSERT INTO [STAReasons] ([Name]) VALUES (@Name)" 
        UpdateCommand="UPDATE [STAReasons] SET [Name] = @Name WHERE [Id] = @Id">
        <DeleteParameters>
